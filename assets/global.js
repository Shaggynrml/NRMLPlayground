...
class ShaggyVariantRadio extends HTMLElement{
  constructor() {
    super();
  ...
  updateOptions() {
    ...
    if (fieldset) {
      ...
      if (checkedRadio) {
        ...
        this.variantID = selectedValue; // You can replace this with your desired handling logic
      }
    }
    // this.variantID = fieldset.querySelectorAll('input').find((radio) => radio.checked).value;
    return this.variantID
  }

  updateMasterId() {
    this.currentVariant = this.getVariantData().find((variant) => {
      return variant.id === parseInt(this.variantID);
    });
  }
...
customElements.define('shaggy-variant-radio',ShaggyVariantRadio);
